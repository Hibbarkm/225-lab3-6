pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/hibbarkm'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Hibbarkm/225-lab3-6.git'                                          //<------change this
        KUBECONFIG = credentials('hibbarkm-225')                                                         //<------change this
    }
